...
Public Class frmClie1

    Private Sub frmSubMenu_Load(sender As Object, e As EventArgs) Handles MyBase.Load



        Dim bColor = ColorTranslator.FromHtml("#f9aa33")
        Dim imgFondo As Object = imgFClie
        ...
        Me.Button1.Text = "CLIENTES 1"
        Me.Button2.Text = "CLIENTES 2"
        Me.Button3.Text = "CLIENTES 3"
        Me.Button4.Text = "CLIENTES 4"
        Me.Button5.Text = "CLIENTES 5"
        Me.Button6.Text = "CLIENTES 6"
        Me.Button7.Text = "CLIENTES 7"
        Me.Button8.Text = "CLIENTES 8"
        Me.Button9.Text = "CLIENTES 9"
        Me.Button10.Text = ""
    End Sub
